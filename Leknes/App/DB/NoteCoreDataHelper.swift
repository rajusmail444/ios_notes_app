...
class NoteCoreDataHelper {
    ...
    static func createNoteInCoreData(noteToBeCreated: NoteDataModel,
    ...
    static func changeNoteInCoreData(noteToBeChanged: NoteDataModel,
    ...
    static func readNotesFromCoreData(fromManagedObjectContext: NSManagedObjectContext) -> [NoteDataModel] {
        var returnedNotes = [NoteDataModel]()
        ...
        do {
            ...
            fetchedNotesFromCoreData.forEach { (fetchRequestResult) in
                ...
                returnedNotes.append(NoteDataModel.init(noteId: noteManagedObjectRead.value(forKey: "noteId") as! UUID,
    ...
    static func readNoteFromCoreData(noteIdToBeRead: UUID,
                                     fromManagedObjectContext: NSManagedObjectContext) -> NoteDataModel? {
        ...
        do {
            ...
            return NoteDataModel.init(noteId: noteManagedObjectToBeRead.value(forKey: "noteId") as! UUID,
    ...
    static func deleteNoteFromCoreData(noteIdToBeDeleted: UUID,
